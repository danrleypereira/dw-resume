...
\cvsection[page1sidebar]{Perfil Profissional}

Fundador e engenheiro de software com atuação desde 2017 em desenvolvimento full-stack, IA, pipelines de dados e nuvem. Trabalho com diretores na entrega de aplicações financeiras, design systems reutilizáveis e automação de testes. Combino desenvolvimento, mentoria e transferência de conhecimento para que as equipes dos clientes mantenham e evoluam as soluções com autonomia.
...
\item[--] Fundei e lidero a DW Corp, criando bases tecnológicas reutilizáveis para acelerar o lançamento de produtos com qualidade empresarial.
\item[--] Desenvolvi agentes LangChain/LangGraph (assistente de orçamento no WhatsApp e barramento multiagente orientado a eventos) com uma interface comum a múltiplos provedores de LLM.
\item[--] Desenvolvi o Curupira, plataforma de autenticação Rust/OIDC (multi-tenancy, SSO, MFA); integrei Stripe e Adyen; padronizei CI/CD e infraestrutura bare-metal e de nuvem híbrida (Terraform, Grafana).
\item[--] Contratei e ofereci mentoria a mais de 10 engenheiros e lidero a primeira comunidade de Software Craftsmanship de Brasília.
\end{itemize}
\textbf{Tecnologias:} Python, LangChain, LangGraph, Rust, Next.js, Stripe, Adyen, Terraform, Grafana, Docker, Kubernetes.
\vspace{4mm}

\textbf{Cliente: empresa do setor financeiro (TAMP)}\\
\textit{set 2025 - set 2026 | Contrato via DW Corp LTDA}
\begin{itemize}
\setlength{\itemindent}{0.5em}
\item[--] Implementei e mantive o design system do cliente em microfrontends React e Vue, ampliando a biblioteca de componentes reutilizáveis com Storybook e Chromatic.
\item[--] Aprimorei as práticas de SDET e QA nas aplicações da equipe, estruturando uma pirâmide de testes unitários, de API e de ponta a ponta. Contribuí para elevar a cobertura de testes unitários de menos de 50\% para quase 97\%.
\item[--] Automatizei fluxos de negócio entre microfrontends com Playwright e Cucumber/Gherkin e a preparação de dados por API com Bruno. Assim, os analistas de QA puderam focar em casos de borda.
\item[--] Disponibilizei resultados de testes em painéis Allure com cenários, diagnóstico de falhas, vídeos e capturas de tela. As melhorias aumentaram a confiança nas entregas e ajudaram a equipe a passar de implantações mensais para semanais.
\item[--] Desenvolvi uma plataforma que reduziu de meses para dias a entrega de novos relatórios personalizados, superando uma desvantagem competitiva que dificultava vendas. Contribuí para fechar ao menos dois grandes contratos e reter um cliente que cogitava sair.
\end{itemize}
\textbf{Tecnologias:} React, Vue, Storybook, Chromatic, Playwright, Allure, Cucumber, Gherkin, Bruno, Typst, AWS Lambda, S3, ECS, EBS.

\newpage
\cvsection[skills-continuation]{Experiência}
\cvevent{Fundador e Engenheiro de IA (continuação)}{DW Corp LTDA}{mar 2025 - Atual}{Brasília - Brasil}

\textbf{Cliente: empresa do setor financeiro (CBMS)}\\
\textit{mar 2025 - ago 2025 | Contrato de seis meses via DW Corp LTDA}
\begin{itemize}
\setlength{\itemindent}{0.5em}
\item[--] Trabalhei diretamente com diretores na modernização de um sistema financeiro legado, como único responsável pela aplicação React voltada ao usuário, com tabelas, gráficos e filtros.
\item[--] Criei um design system completo no Figma com o diretor de UI/UX e implementei uma biblioteca de mais de 30 componentes reutilizáveis com Tailwind CSS, Radix UI, Storybook e Chromatic.
\item[--] Contribuí para pipelines ETL em Python, com apoio de engenharia de dados, usando AWS Step Functions, SQS, SNS e Lambda. Integrei a aplicação a dados reais coletados de bancos e instituições financeiras, entregando além do escopo do MVP em seis meses.
\item[--] Concluí a transição acordada com a diretoria e conduzi capacitações em React para que a equipe de PHP/Twig assumisse a manutenção e evolução da aplicação ao término do contrato.
\end{itemize}
\textbf{Tecnologias:} React, React Router Framework (SSR), FastAPI, Python, Boto3, AWS Step Functions, SQS, SNS, Lambda, Figma, Tailwind CSS, Radix UI, Storybook, Chromatic.
\vspace{4mm}
...
\cvevent{Cofundador e Líder da Comunidade}{Software Craftsmanship Community Brasília}{Final de 2023 - Atual}{Brasília - Brasil}
\begin{itemize}
\setlength{\itemindent}{0.5em}
\item[--] Cofundei a comunidade com minha companheira e amigos, inspirado pelo encontro com Sandro Mancuso e a Codurance e pelo movimento global de Software Craftsmanship.
\item[--] Organizo encontros mensais, palestras em universidades e desafios de programação com TDD; ofereço mentoria em Extreme Programming (XP) e difundo o Manifesto Software Craftsmanship.
\item[--] Desenvolvi com a comunidade o \href{https://dwcorp.com.br/arandu}{Arandu}, nosso blog, usando Django e Next.js.
\item[--] Liderei a programação de um palco inteiro na edição nacional da Campus Party Brasil 2025, com palestras sobre SOLID, Clean Architecture, Manifesto Software Craftsmanship, Scrum, riscos de segurança do OWASP Top 10 e uso de IA em SDET para melhorar a qualidade de software, além de palestras com fundadores de startups.
\end{itemize}
