...
Fundador e ingeniero de software con experiencia desde 2017 en desarrollo full-stack, IA, pipelines de datos e infraestructura en la nube. Colaboro directamente con directivos para entregar aplicaciones financieras, sistemas de diseño reutilizables y automatización de pruebas. Combino desarrollo, mentoría y transferencia de conocimiento para que los equipos de los clientes mantengan y evolucionen las soluciones con autonomía.
...
\item[--] Fundé y lidero DW Corp, creando bases tecnológicas reutilizables para acelerar el lanzamiento de productos con calidad empresarial.
\item[--] Desarrollé agentes LangChain/LangGraph (asistente de presupuesto por WhatsApp y bus multiagente orientado a eventos) con una interfaz común para múltiples proveedores de LLM.
\item[--] Desarrollé Curupira, una plataforma de autenticación Rust/OIDC (multi-tenancy, SSO, MFA); integré Stripe y Adyen; estandaricé CI/CD e infraestructura bare-metal y de nube híbrida (Terraform, Grafana).
\item[--] Contraté y ofrecí mentoría a más de 10 ingenieros y lidero la primera comunidad de Software Craftsmanship de Brasília.
\end{itemize}
\textbf{Tecnologías:} Python, LangChain, LangGraph, Rust, Next.js, Stripe, Adyen, Terraform, Grafana, Docker, Kubernetes.
\vspace{4mm}

\textbf{Cliente: empresa del sector financiero (TAMP)}\\
\textit{sep 2025 - sep 2026 | Contrato a través de DW Corp LTDA}
\begin{itemize}
\setlength{\itemindent}{0.5em}
\item[--] Implementé y mantuve el sistema de diseño del cliente en microfrontends React y Vue, ampliando la biblioteca de componentes reutilizables con Storybook y Chromatic.
\item[--] Reforcé las prácticas de SDET y QA en las aplicaciones del equipo, estableciendo una pirámide de pruebas unitarias, de API y de extremo a extremo. Contribuí a elevar la cobertura de pruebas unitarias de menos del 50\% a casi el 97\%.
\item[--] Automaticé flujos de negocio entre microfrontends con Playwright y Cucumber/Gherkin, automatizando llamadas a API con Bruno para preparar los datos de cada escenario. Esto permitió al equipo de QA centrarse en casos límite.
\item[--] Hice accesibles los resultados de pruebas mediante paneles Allure con escenarios, diagnóstico de fallos, vídeos y capturas de pantalla. Estas mejoras reforzaron la confianza en las entregas y ayudaron al equipo a pasar de despliegues mensuales a semanales.
\item[--] Desarrollé una plataforma que redujo de meses a días la entrega de nuevos informes personalizados, resolviendo una desventaja competitiva que dificultaba las ventas. Contribuí a cerrar al menos dos grandes contratos y a retener a un cliente en riesgo de abandonar el servicio.
\end{itemize}
\textbf{Tecnologías:} React, Vue, Storybook, Chromatic, Playwright, Allure, Cucumber, Gherkin, Bruno, Typst, AWS Lambda, S3, ECS, EBS.

\newpage
\cvsection[skills-continuation]{Experiencia}
\cvevent{Fundador e Ingeniero de IA (continuación)}{DW Corp LTDA}{mar 2025 - Actualidad}{Brasília - Brasil}

\textbf{Cliente: empresa del sector financiero (CBMS)}\\
\textit{mar 2025 - ago 2025 | Contrato de seis meses vía DW Corp LTDA}
\begin{itemize}
\setlength{\itemindent}{0.5em}
\item[--] Colaboré directamente con directivos para modernizar un sistema financiero heredado, como único responsable de la aplicación React de cara al usuario, con tablas, gráficos y filtros.
\item[--] Creé un sistema de diseño completo en Figma junto al director de UI/UX e implementé una biblioteca de más de 30 componentes reutilizables con Tailwind CSS, Radix UI, Storybook y Chromatic.
\item[--] Contribuí a pipelines ETL en Python, con apoyo de ingeniería de datos, usando AWS Step Functions, SQS, SNS y Lambda. Integré la aplicación con datos reales extraídos de bancos e instituciones financieras, superando el alcance del MVP en seis meses.
\item[--] Completé el traspaso acordado con la dirección e impartí sesiones de formación en React para que el equipo de PHP/Twig asumiera el mantenimiento y la evolución de la aplicación al finalizar el contrato.
\end{itemize}
\textbf{Tecnologías:} React, React Router Framework (SSR), FastAPI, Python, Boto3, AWS Step Functions, SQS, SNS, Lambda, Figma, Tailwind CSS, Radix UI, Storybook, Chromatic.
\vspace{4mm}
...
\item[--] Codirigí un trabajo de fin de grado sobre el diseño de un sistema RAG para el poder judicial brasileño (calificación: 9,0/10).
...
\cvevent{Cofundador y Líder de la Comunidad}{Software Craftsmanship Community Brasília}{Finales de 2023 - Actualidad}{Brasília - Brasil}
\begin{itemize}
\setlength{\itemindent}{0.5em}
\item[--] Cofundé la comunidad con mi pareja y amigos, inspirado por el encuentro con Sandro Mancuso y Codurance y por el movimiento global de Software Craftsmanship.
\item[--] Organizo encuentros mensuales, charlas en universidades y retos de programación con TDD; ofrezco mentoría en Extreme Programming (XP) y difundo el Manifiesto de Software Craftsmanship.
\item[--] Desarrollé junto a la comunidad \href{https://dwcorp.com.br/arandu}{Arandu}, nuestro blog, con Django y Next.js.
\item[--] Lideré la programación de un escenario completo en la edición nacional de Campus Party Brasil 2025, con charlas sobre SOLID, Clean Architecture, el Manifiesto de Software Craftsmanship, Scrum, riesgos de seguridad del OWASP Top 10 y uso de IA en SDET para mejorar la calidad del software, además de charlas de fundadores de startups.
\end{itemize}
